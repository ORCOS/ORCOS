...
AFLAGS =
CFLAGS = -c -I$(ORCOS_LIB_DIR)/inc -I$(ORCOS_LIB_DIR)/inc/$(BUILD_PLATFORM) -mno-unaligned-access -fno-exceptions -fno-rtti -O2 -mthumb -Wno-write-strings -ffunction-sections
CPPFLAGS = $(CFLAGS) -g
