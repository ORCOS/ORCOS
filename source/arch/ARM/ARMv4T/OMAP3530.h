...
#define GPT5_TIER	GPT5_BASE_ADDR + TIER_OFFSET
#define GPT5_TISR	GPT5_BASE_ADDR + TISR_OFFSET
#define GPT5_TCLR	GPT5_BASE_ADDR + TCLR_OFFSET
#define GPT5_TPIR	GPT5_BASE_ADDR + TPIR_OFFSET
#define GPT5_TNIR	GPT5_BASE_ADDR + TNIR_OFFSET
#define GPT5_TLDR	GPT5_BASE_ADDR + TLDR_OFFSET
#define GPT5_TCRR	GPT5_BASE_ADDR + TCRR_OFFSET
#define GPT5_TOCR	GPT5_BASE_ADDR + TOCR_OFFSET
#define GPT5_TOWR	GPT5_BASE_ADDR + TOWR_OFFSET
