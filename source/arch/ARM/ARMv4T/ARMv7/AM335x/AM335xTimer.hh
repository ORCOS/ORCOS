...
typedef struct {
    ...
    volatile unint4 reserved4;   /* 0x18 */
    volatile unint4 reserved5;   /* 0x1c */
    volatile unint4 irq_eoi;     /* 0x20 */
    volatile unint4 tistat;      /* 0x24 */
    volatile unint4 tisr;        /* 0x28 */
    volatile unint4 tier;        /* 0x2c */
    volatile unint4 tieclr;      /* 0x30 */
    volatile unint4 twer;        /* 0x34 */
    volatile unint4 tclr;        /* 0x38 */
    volatile unint4 tcrr;        /* 0x3c */
    volatile unint4 tldr;        /* 0x40 */
    volatile unint4 ttgr;        /* 0x44 */
    volatile unint4 twps;        /* 0x48 */
    volatile unint4 tmar;        /* 0x4c */
    volatile unint4 tcar1;       /* 0x50 */
    volatile unint4 tsicr;       /* 0x54 */
    volatile unint4 tcar2;       /* 0x58 */
...
public:
    /*****************************************************************************
     * Method: AM335xTimer(T_AM335xTimer_Init * init)
     *
     * @description
     *******************************************************************************/
    explicit AM335xTimer(T_AM335xTimer_Init * init);
    ~AM335xTimer();
    ...
    *******************************************************************************/
     ...
     *******************************************************************************/
    inline ErrorT clearIRQ(int irq) {
