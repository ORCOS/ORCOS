...
// TODO update t new arch mappings struct
...
void* PPC405HatLayer::map(void* logBaseAddr, void* physBaseAddr, size_t size, BitmapT protection, byte zsel, int pid, bool cache_inhibit) {
    PPC405TlbEntry tlbe;
    int index;
    ErrorT status = 0;
