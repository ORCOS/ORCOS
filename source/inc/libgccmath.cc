...
/*****************************************************************************
 * Method: __udivmoddi4(unint8 num, unint8 den, unint8 *rem_p)
 *
 * @description
 *******************************************************************************/
 ...
 *******************************************************************************/
/*****************************************************************************
 * Method: __udivdi3(unint8 num, unint8 den)
 *
 * @description
...
extern "C" int8 __divdi3(int8 u, int8 v) {
    ...
    w = __udivmoddi4(uu.ll, vv.ll, reinterpret_cast<unint8*>(0));
    if (c)
        w = -w;
...
extern "C" unint8 __moddi3(unint8 u, unint8 v) {
    ...
    __udivmoddi4(uu.ll, vv.ll, reinterpret_cast<unint8*>(&w));
    if (c)
        w = -w;
